...
class RegisterAccountVerificationController extends GetxController {
  ...
  Future<void> resendOTP(String email) async {
    try {
      final result = await registrationAccountService.sendOTP(email);
  ...
  Future<void> checkOTP() async {
    ...
    try {
      showLoading();
      final result = await registrationAccountService.checkOTP(emaill, otp);
